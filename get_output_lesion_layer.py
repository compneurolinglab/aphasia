...
# Compile regular expression to match Transformer layers
...
# Loop through and disable each layer
for layer_index in tqdm(range(num_layers), desc="Disabling layers"):
    try:
        ...
        for name, param in model.named_parameters():
            ...
            # Match model layers and extract the current layer index using regex
